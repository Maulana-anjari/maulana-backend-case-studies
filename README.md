...
|---|---|---|
| [Pertamina EP WOPDM Z4 LLM Insight Platform](case-studies/pertamina-llm-insight-platform.md) | Python, FastAPI, SQL Server, Milvus, Redis, RBAC | 51.9% faster issue-to-merge lead time |
...
- This repo is optimized for recruiter review and quick scanning.
